 ...
 *   3. Render last.
 *
 * Step 2 runs on this surface too, even though a session unlocks nothing for an ordinary customer.
 * An operator IS served by the chain index (`indexer/src/server.ts:695`), and the code has to leave
 * the address bar whether or not the page that follows uses it — a hand-off code sitting in a
 * shared link is a hand-off code somebody else can redeem.
 */
