 ...
 * never by status (`indexer/src/server.ts`):
 *
 ...
 *       the path names a chain this estate does not run (`indexer/src/server.ts`).
 *   `not_found`
 ...
 * have helped.
 *
 * `micro-indexer` opened the seven reads (`authoriseRead`, `indexer/src/server.ts`), and
