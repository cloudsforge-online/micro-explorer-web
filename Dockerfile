...
# know whether the API behind the page is healthy, and on this surface it cannot even know whether
# that API would answer this bundle at all. Pretending otherwise is how a green probe outlives a
# broken product.
