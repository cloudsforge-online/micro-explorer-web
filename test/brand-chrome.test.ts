...
test('the accent selector this page names really exists, and "explorer" would NOT have', (t) => {
  ...
  // mapped to whichever the scheme resolves — see `tokens.css`, which declares both and maps the
  // light one under its own scheme block. The dark one is the value to compare, because it is the hue this estate has always
